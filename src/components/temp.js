    ...
    render: function () {
        ...
        if (this.state.fetch === "true") {
            return (
                <div>
                    <center>
                        <TextField className={"searchfield"} id="link"
                                   hintText="Ex. https://hackbit.github.io/reactriot2017-manishbisht/"/>
                        <RaisedButton className={"searchbutton"} onClick={this.addtolist} label="Add to list"
                                      primary={true}/>
                        <FlatButton className={"logoutbutton"} onClick={this.logout} label="Logout" secondary={true}
                            ...
                            {_data.map(function (object, i) {
                                return <div className={"row"} key={i}>
                                    <Card className={"card"}>
                                        ...
                                        <CardTitle className={"cardtitle"} titleStyle={titlestyle}
                                                   title={object.val().title}
                                                   subtitle={object.val().created}/>
